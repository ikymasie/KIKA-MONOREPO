    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 pb-20">
            ...
            <header className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 flex items-center gap-8">
                ...
                <div>
                    <h1 className="text-3xl font-black text-slate-900">Member Management</h1>
                    <p className="text-slate-500 font-medium">
                        {appName ? appName : 'Founding members and office bearers'}
                    </p>
                </div>
            </header>
            ...
            {applicationId ? (
                <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    <MemberManagement applicationId={applicationId} onUpdate={() => { }} />
                </div>
            ) : (
