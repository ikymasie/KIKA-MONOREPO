...
const navItems: NavItem[] = [
    ...
    { name: 'My Savings', href: '/member/savings', icon: '💵' },
    { name: 'My Loans', href: '/member/loans', icon: '💰' },
    { name: 'Apply for Loan', href: '/member/apply-loan', icon: '📝' },
    { name: 'Insurance', href: '/member/insurance', icon: '🛡️' },
    { name: 'Marketplace', href: '/member/marketplace', icon: '🛒' },
    { name: 'Statements', href: '/member/statements', icon: '📄' },
            ...
            <div className="p-6 border-b border-white/20 bg-white/10 backdrop-blur-md">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-[10px] text-primary-600 font-bold uppercase tracking-widest">Member Portal</p>
                    </div>
                </div>
            </div>
